...
while {true} do {
	...
	gdtmod_seagull_players = [];
	{if ((alive _x) && (_x distance specPen > 200) && (_x != player) && (isPlayer _x) && !(_x isKindOf "Logic") && (vehiclevarname _x != "camman")) then {gdtmod_seagull_players = gdtmod_seagull_players + [_x]; }} foreach allUnits;
	gdtmod_seagull_players_count = count gdtmod_seagull_players - 1;
